...
void customDrawMatches(cv::Mat& inputImage1, std::vector<cv::Point2f>& kPoints1, cv::Mat & inputImage2, std::vector<cv::Point2f>& kPoints2, cv::String winName = "Matches", int radius = 20, int thickness = 13, int option = DRAW_ALL);
